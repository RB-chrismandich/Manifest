...
- **Automatic Synthesis**: Disagreement resolution when consensus < 50% using
  Claude Sonnet
- **Streaming Responses**: Real-time Rich Live display with progressive
  updates (4 updates/sec)
...
| --- | --- | --- | --- |
| `/project-commit` | Full commit pipeline: docs, pull, pre-commits, commit, push | CONDITIONAL | Tier 1 + Tier 2 |
| `/refactor-python` | Python security, architecture, code quality analysis | ALWAYS | Tier 1 + Tier 2 |
| `/refactor-shell` | Bash/Shell script security and quality with shellcheck | ALWAYS | Tier 1 + Tier 2 |
| `/docs-diagrams` | Generate Mermaid architecture flowcharts and sequence diagrams | CONDITIONAL | Tier 2 |
...
| `/issue-prioritize` | Fetch and rank open issues by impact, urgency, readiness, risk | CONDITIONAL | Tier 2 |
| `/issue-triage` | Linear issue audit: duplicates, staleness, priority validation | CONDITIONAL | Tier 2 |
| `/plan-manage` | Plan lifecycle: create, review, execute, archive, abandon | CONDITIONAL | Tier 2 |
| `/browser-test` | AI-powered E2E browser testing via browser-use YAML prompts | CONDITIONAL | Tier 2 |
...
| --- | --- | --- | --- |
| [Getting Started](docs/GETTING_STARTED.md) | First-time setup walkthrough | New users | 10m |
| [Configuration](docs/CONFIGURATION.md) | Config options, YAML ref, env vars | Operators | 15m |
| [Architecture](docs/ARCHITECTURE_DIAGRAMS.md) | Visual system documentation | Developers | 20m |
| [Troubleshooting](docs/TROUBLESHOOTING.md) | Common problems, solutions | All users | 10m |
| [AGENTS.md](AGENTS.md) | AI agent instructions | AI assistants | 8m |
| [CLAUDE.md](CLAUDE.md) | Claude Code-specific project context | AI assistants | 8m |
