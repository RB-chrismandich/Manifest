...
**Location**: `../../runtime/bin/git_platform.sh`
...
```bash
../../runtime/bin/git_platform.sh [remote_name]
```
...
../../runtime/bin/git_platform.sh upstream
# Output: gitlab

# Force platform override
MANIFEST_GIT_PLATFORM=gitlab ../../runtime/bin/git_platform.sh
# Output: gitlab
```

### Operations Wrapper Script

**Location**: `../../runtime/bin/git_ops.sh`
...
```bash
../../runtime/bin/git_ops.sh <subcommand> [args...]
```
...
../../runtime/bin/git_ops.sh issue-view 123

# Create a pull/merge request
../../runtime/bin/git_ops.sh pr-create --title "Fix bug" --body "Description"

# List open issues
../../runtime/bin/git_ops.sh issue-list --state open
```
