...
# version_pin_hook.sh - manifest-ops PostToolUse adapter (warn-only)
#
...
#
# The ownership-marked plugin registration lives in hooks/version-pin.json.
# Unsupported harnesses expose the on-demand skill and report degradation.
