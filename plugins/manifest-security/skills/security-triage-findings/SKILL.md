...
For three or more candidate findings, triage one finding per review unit and
aggregate structured verdicts. Below that threshold, triage inline; if
structured output is unavailable, report `DEGRADED`.
