...
Assign ready workflow-audit units through the shared native dispatch contract.
Each reviewer owns one workflow; the parent validates and merges structured
findings.
