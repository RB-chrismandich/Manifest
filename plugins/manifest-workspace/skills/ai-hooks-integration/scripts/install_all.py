...
def install_unified(args) -> None:
    ...
    run(
        [
            ...
            "--command",
            f"{unified_cmd} --source claude --event-type PreToolUse",
            *ownership,
            *dry,
        ],
        "claude",
    ...
    run(
        [
            ...
            "--command",
            f"{unified_cmd} --source gemini --event-type BeforeTool",
            *ownership,
            *dry,
        ],
        "gemini",
    ...
    run(
        [
            ...
            "--command",
            f"{unified_cmd} --source cursor --event-type beforeShellExecution",
            *ownership,
            *dry,
        ],
        "cursor",
