...
template. You must eliminate all conversational preamble, metadata explanations, and post-generation fluff.
...
3. **Inject Safeguards**: Embed the absolute pathing, pythonic runtime rules, and idempotency constraints
   directly into the generated payload.
