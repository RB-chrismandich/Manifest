...
description: "Automated Meta-Prompt Optimization Engine (Jules Target)"
---

# Automated Meta-Prompt Optimization Engine (Jules Target)
...
Every generated or refactored skill payload *must* programmatically embed the following architectural rules into
its `<constraints>` block:
