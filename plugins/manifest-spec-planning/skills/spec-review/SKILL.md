---
name: spec-review
description: Cross-reference spec/plan/tasks artifacts for internal consistency through a selected native reviewer. Analysis-only, never edits. Speckit and design-doc layouts; auto-discovers or takes explicit paths.
---
...
Layout detection (speckit `spec/plan/tasks` vs design-doc `design + plan`, with
