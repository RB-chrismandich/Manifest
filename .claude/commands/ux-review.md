---
description: Automated UX audit for accessibility, responsive design, and performance
...
- Skill path: `~/.claude/skills/ux-review/SKILL.md`
- Canonical repo path: `.claude/skills/ux-review/SKILL.md`
