...
contributors
**Purpose**: Provide AI agents with repository structure, deployment process, and
testing guidelines
...
- **Apify MCP**: web scraping, data extraction, and crawling tasks that
  require fetching structured data from external websites.
