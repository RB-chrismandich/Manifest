...
**Purpose**: Provide AI agents with structure, deployment, and testing guidelines
...
```text
configs/                             # Deployment source configs (deployed to ~/)
...
`~/.gemini/skills`). To add a new skill, follow the Claude Code skill instructions
above.
