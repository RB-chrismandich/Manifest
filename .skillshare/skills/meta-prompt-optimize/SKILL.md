...
<problem_structure>
  ...
  <preliminary_context>
    When a raw prompt payload is received via the scheduled task pipeline, execute four processing cycles:
    1. Deconstruct intent and context. 2. Normalize to XML schema. 3. Inject path, runtime, and idempotency safeguards.
    4. Cleanse conversational text.
  </preliminary_context>
