...
lines.append("**Managed by**: `learning-capture` skill, `antipattern-detect` skill")
lines.append("")
lines.append("---")
lines.append("")
...
lines.append("Entries are captured by the `learning-capture` skill and `antipattern-detect` skill.")
lines.append("To add entries, use `learning_capture.sh add` or the `/learning-capture` skill.")
lines.append("")
lines.append("## How to Contribute")
lines.append("")
lines.append("| Action | Command | Description |")
lines.append("| ------ | ------- | ----------- |")
lines.append("| Capture a new learning | `/learning-capture` | Records a pattern, tool discovery, or config insight |")
...
lines.append("- **Learning loop skill**: [`configs/claude/skills/learning-capture/`](../configs/claude/skills/learning-capture/)")
