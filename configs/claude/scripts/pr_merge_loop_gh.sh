...
# help-coverage: exempt — sourced fragment of pr_merge_loop.sh, not a standalone
# entry point (matches plugins/manifest-forge/runtime/bin/lib/lifecycle_tracker.sh).
