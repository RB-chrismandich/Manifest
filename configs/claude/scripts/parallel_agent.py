...
async def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python parallel_agent.py "Review the tuning orchestrator for bugs"
  python parallel_agent.py --analyze src/tuning/orchestrator.py
  python parallel_agent.py --cursor-model advanced --claude-model opus --review critical_auth.py
  python parallel_agent.py --claude-only --claude-model haiku "Quick question"
"""
    )
    ...
    opt_group = parser.add_argument_group("Execution & Output Options")
    opt_group.add_argument("--json", action="store_true", help="Output JSON format")
    opt_group.add_argument("--validate", action="store_true", help="Validate results")
    opt_group.add_argument("--output", metavar="DIR", help="Custom output directory")
