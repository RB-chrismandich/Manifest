...
class Orchestrator:
    ...
    def _calculate_consensus(self, results: Dict) -> Dict:
        ...
        # Performance optimization: utilize set comprehensions and
        # collections.Counter to significantly speed up word counting and
        # uniqueness checks.
        word_sets = [
        ...
        word_counts = Counter(word for word_set in word_sets for word in word_set)
