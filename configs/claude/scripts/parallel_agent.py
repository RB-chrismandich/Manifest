...
async def main():
    ...
    epilog = """
Examples:
  # Basic code review with all 4 agents
  python parallel_agent.py --review src/main.py

  # Security analysis with maximum capability models
  python parallel_agent.py --analyze auth.py --claude-model opus --cursor-model advanced

  # Quick query disabling Codex and streaming JSON
  python parallel_agent.py "Explain this function" --no-codex --json
"""
    ...
    misc_group.add_argument("--validate", action="store_true", help="Validate results")
