...
@test "transition_issue fail-open on tracker rc=3 (jira-style MCP-only): returns 0, logs unsupported-in-context, does not mark [failed]" {
    mk_issue 17 open planned
...
@test "transition_issue fail-open on tracker rc=4 (verb not implemented): returns 0, logs reason, does not mark [failed]" {
    mk_issue 17 open planned
