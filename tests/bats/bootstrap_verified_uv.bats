...
@test "verified uv module declares the committed release version when sourced" {
    run bash -c 'source "'"$INSTALL_LIB"'"; printf "%s" "$UV_INSTALLER_PINNED_VERSION"'

    assert_success
    assert_output "0.12.6"
}
