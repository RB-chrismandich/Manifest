...
**Learning:** Refactoring meta-prompts requires careful preservation of literal XML schemas to avoid disrupting
downstream parsers.
**Action:** Overwrote `.skillshare/skills/prompt-optimize/SKILL.md` with explicit literal XML schemas and rigid
guardrails from the target blueprint.
