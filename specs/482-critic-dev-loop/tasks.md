...
- [X] T037 [P] Add the `tool_policies` entry for `spec-implement-loop` in `configs/claude/config/command_config.yml`: allowed `[Bash, Read]`, no OMP task dispatch, `validation_tier: 1`, with rationale (research D12)
