...
| IV. Skill-First Extensibility | **PASS** | New user capability is the `/deploy-reconcile` skill wrapping a dedicated script (branch-clean precedent). No behavior added to the retired cross-harness coordinator or other core scripts. |
