...
- `.skillshare/skills/deploy-drift-root-cause/SKILL.md` — MISSING-state concern (inverse).
- `.skillshare/skills/sync-configs/SKILL.md`, `health-check/SKILL.md` — read-only diagnostics.
