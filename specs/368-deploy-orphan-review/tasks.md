...
`.skillshare/skills/`; bootstrap integration in `bootstrap/`; tests in `tests/bats/`
...
- [x] T003 [P] Create `.skillshare/skills/deploy-reconcile/SKILL.md` scaffold with `name: deploy-reconcile` + a triggering `description` frontmatter (body filled in T014).
...
- [x] T014 [P] [US1] Fill `.skillshare/skills/deploy-reconcile/SKILL.md` body per contract §11 (Preview → Apply-with-confirm → Review-outcome → Safety), modeled on `branch-clean`.
