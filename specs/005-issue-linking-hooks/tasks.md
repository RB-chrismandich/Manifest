...
- [X] T031 Tier 1 cross-verification (Constitution II): run `the retired cross-harness coordinator --review` on the `issue_support.sh` + `git_ops.sh` diff (token handling + >200 lines) before opening the PR
