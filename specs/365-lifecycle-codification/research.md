...
- **Reused as-is**: smoke orchestrator (`smoke_test.py`), `git_ops.sh`/`git_platform.sh`/`linear_ops.sh`, `labels.yml`/`label_sync.sh`, the Atlassian MCP, `the retired cross-harness coordinator`, the 360/361 decide-core idiom.
