...
Configuration-toolkit repo (no `src/`): content lands in `configs/claude/`, `.skillshare/skills/`, `tests/bats/`, `tests/fixtures/` per plan.md Project Structure.
