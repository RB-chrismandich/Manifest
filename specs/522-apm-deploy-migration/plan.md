...
- **Self-correction**: adding pre-GO publish gates contradicted FR-001 ("no source modified before GO"). Rather than leave the conflict, FR-001 gained one narrow, justified carve-out — additive, self-contained, valuable under NO-GO — with the verification task asserting nothing else claims it.
