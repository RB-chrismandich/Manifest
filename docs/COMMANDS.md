...
| `/spec-review` | Cross-reference spec/plan/tasks artifacts for internal consistency via the parallel-agent panel. Analysis-only, never edits. Works with speckit and superpowers layouts. | Cross-reference spec/plan/tasks artifacts for internal consistency via the parallel-agent panel. | available |
