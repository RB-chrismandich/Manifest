...
_107 commands, generated from `.apm/skills/*/SKILL.md`._
...
| `/meta-prompt-optimize` | Use when a user asks to create, optimize, refactor, or harden a prompt into a production-ready skill template. Refactors raw prompts into a fixed XML-schema payload, stripping conversational preamble and injecting absolute-path, idempotency, and runtime guardrails. | Use when a user asks to create, optimize, refactor, or harden a prompt into a production-ready skill template. | available |
