...
| `manifest-workspace:hook:claude-compaction-continuity` | contract hook | BLOCKED(components evidence missing manifest-workspace:hook:claude-compaction-continuity) | N/A(Codex exposes no verified completed-compaction lifecycle sequence.) | N/A(Gemini exposes no verified completed-compaction lifecycle sequence.) | N/A(Cursor exposes no verified completed-compaction lifecycle sequence.) | N/A(Antigravity exposes no verified completed-compaction lifecycle sequence.) | N/A(Devin exposes no verified completed-compaction lifecycle sequence.) |
...
| `manifest-workspace:runtime:session-checkpoint-references` | contract runtime | BLOCKED(components evidence missing manifest-workspace:runtime:session-checkpoint-references) | BLOCKED(components evidence missing manifest-workspace:runtime:session-checkpoint-references) | BLOCKED(components evidence missing manifest-workspace:runtime:session-checkpoint-references) | BLOCKED(components evidence missing manifest-workspace:runtime:session-checkpoint-references) | BLOCKED(components evidence missing manifest-workspace:runtime:session-checkpoint-references) | BLOCKED(components evidence missing manifest-workspace:runtime:session-checkpoint-references) |
| `manifest-workspace:runtime:session-continuity-scripts` | contract runtime | BLOCKED(components evidence missing manifest-workspace:runtime:session-continuity-scripts) | BLOCKED(components evidence missing manifest-workspace:runtime:session-continuity-scripts) | BLOCKED(components evidence missing manifest-workspace:runtime:session-continuity-scripts) | BLOCKED(components evidence missing manifest-workspace:runtime:session-continuity-scripts) | BLOCKED(components evidence missing manifest-workspace:runtime:session-continuity-scripts) | BLOCKED(components evidence missing manifest-workspace:runtime:session-continuity-scripts) |
